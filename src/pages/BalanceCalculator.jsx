...
const BalanceCalculator = () => {
  ...
  return (
    <main className="flex flex-col transition-all duration-200 ease-in-out">
      <div className="min-w-[580px] w-4/5 md:w-3/4 lg:w-3/5 mx-auto px-4 pb-1 bg-[#0D1E4C]/70 rounded-b-2xl shadow-2xl transform transition-all duration-200 ease-in-out">
        <div className="flex flex-col bg-[#0D1E4C]/50 mb-2 rounded-b-2xl shadow-xl">
