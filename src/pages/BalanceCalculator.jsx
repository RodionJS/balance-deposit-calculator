...
const BalanceCalculator = () => {
  ...
  return (
    <main className="flex flex-col transition-all duration-200 ease-in-out">
      <div className="min-w-[580px] w-4/5 md:w-3/4 lg:w-3/5 mx-auto mt-4 px-4 py-1 bg-[#0D1E4C]/70 rounded-2xl shadow-2xl transform transition-all duration-200 ease-in-out">
